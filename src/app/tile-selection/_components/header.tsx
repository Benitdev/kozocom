...
export default function TileSelectionHeader() {
  return (
    <header className="fixed left-0 top-0 z-[99] flex w-full items-center justify-between p-4 md:px-7">
      ...
      <motion.div
        ...
        className="tile-selection-heading relative z-20 select-none text-center text-base font-bold uppercase text-white md:text-2xl lg:text-3xl"
      >
